...
<body>
    ...
    <ul>
    <li><a href="EmployeeInfo.php">Employee Information Page</a></li>
</ul>
...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			...
			<table class="basic_box">
            <tr>
					<th colspan="2">DELETE EMPLOYEE</th>
				</tr>
				<tr><td><br></td></tr>
				<tr>
					<td colspan="1">Enter Employee ID:</td>
					<td colspan="2">
						<form action="delete_employee(1).php" method="post">
							<input type="number" name="EmployeeID" required>
					</td>
				</tr>
				<tr>
					<td></td>
					<td style="text-align: center;"><button type="submit">Delete</button></td></form>	
				</tr>
			</table>
		</div>
	</body>
