	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		...
		?>
			<table class="basic_box">
				<tr>
					<th colspan="2" style="text-decoration:underline ; font-size:30px;">Booking History</th>
				</tr>
				<tr>
					<td>Booking ID: </td>
				...
				<tr>
					<td colspan="2">
					<button type="button"><a href="user_booking_history.php" style="color: black ; background-color:#f2f2f2; text-decoration:none; font-size:20px;">Back</a></button>
</td>
				</tr>
			</table>
	</div>
