	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		...
		?>
			<table class="basic_box">
				<tr>
					<th colspan="2" style="text-decoration:underline ;">Booking History</th>
				</tr>
				<tr>
					<td>Booking ID: </td>
				...
				<tr>
					<td colspan="2">
					<td><button type="button"><a href="booking_history.php" style="color: black ; margin-top:3% ;text-decoration:none; text-align:center; font-size:20px;">Back</a></button></td>
</td>
				</tr>
			</table>
		</div>
