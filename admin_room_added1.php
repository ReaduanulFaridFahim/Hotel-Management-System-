	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				...
				<tr>
					<td><button type="button"><a href="admin_view.php" style="color: black ; margin-top:3% ;text-decoration:none; font-size:25px;">Click here to get redirected.</a></button></td>
				</tr>
			</table>
		</div>
	</body>
